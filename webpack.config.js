{
  mode: 'production',
  context: 'C:\\Petr\\Git\\build-a-bot',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    process: 'mock',
  ...
  output: {
    path: 'C:\\Petr\\Git\\build-a-bot\\dist',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'C:\\Petr\\Git\\build-a-bot\\public\\index.html'
      }
    ),
    ...
    new CopyPlugin(
      [
        {
          from: 'C:\\Petr\\Git\\build-a-bot\\public',
          to: 'C:\\Petr\\Git\\build-a-bot\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
